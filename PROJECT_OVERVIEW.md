...
- **Sync Status**: Fixed stalled "hydration" (sync) progress. The system now automatically resumes background enrichment when the dashboard status is polled. (Removed legacy "temporarily disabled" flag).
